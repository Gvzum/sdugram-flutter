...
class _AuthSource implements AuthSource {
  ...
  @override
  Future<TokenDto> getToken({required AuthRequestDto body}) async {
  ...
  Future<RegisterResponseDto> register(
      {required RegisterRequestDto body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<RegisterResponseDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = RegisterResponseDto.fromJson(_result.data!);
    return value;
  }

  @override
  Future<UserDataDto> getUserRole() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/integration/user/get-user-data/',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
