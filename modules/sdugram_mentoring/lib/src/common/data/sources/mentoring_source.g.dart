...
class _MentoringSource implements MentoringSource {
  ...
  @override
  Future<ChatMessageDetailsDto> getChatDetail({required int id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ChatMessageDetailsDto>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ChatMessageDetailsDto.fromJson(_result.data!);
    return value;
  }
