...
class _HomeSource implements HomeSource {
  ...
  @override
  Future<void> saveArticle({required SaveArticleRequest request}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/integration/blog/saved-article/',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<void> undoSaveArticle({required SaveArticleRequest request}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/integration/blog/undo-saved-article/',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
